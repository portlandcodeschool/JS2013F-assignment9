...
// Write a test for a new function that lives in the condional.js

test('2 is passed into the function', function (t) {

t.equal(conditionals.isFirstTest(2), true);
...
test('should return a random number between 20 and 30', function (t) {

var random = conditionals.isBetween(20,30);

t.equal(random >= 20 && random <= 30, true);
