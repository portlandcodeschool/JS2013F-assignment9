...
test('should return true when 2 is passed in', function (t) {
  t.equal(conditionals.passVal(2), true);
  t.equal(conditionals.passVal({name: 'steve'}), false);
...
test('should return a number between 20 and 30', function (t) {
  ...
  t.equal(randomNumber >= 20 && randomNumber <=30, true);
...
test('should insert an object at a given array index', function (t) {
  ...
  t.deepEqual(array2, ['a', 'b', 'c', 'Bleep']);
